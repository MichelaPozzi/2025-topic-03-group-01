...
```
*********************************************************************************************************************************************
1.2 Normalization step between the replicates in each fraction and for each treatment using the mean value method by Benjamin Nicklas influenced by ChatGPT
*********************************************************************************************************************************************
...
***********************************************************************************************************
COM-Werte hinzugügen in ctrl_norm_mean
***********************************************************************************************************
```{r}
...
Variablen, die ihr fürs Weitere verwenden könnt

ctrl_selected und rnase_selected
--> Diejenigen Proteine aus ctrl_norm_mean bzw. rnase_norm_mean, die wir als potenziell RNA-abhängig identifiziert haben

ctrl_not_selected und rnase_not_selected
--> Diejenigen Proteine aus ctrl_norm_mean bzw. rnase_norm_mean, die wir nicht als RNA-abhängig identifiziert haben, und die daher rausgeflogen sind

Damit solltet ihr weiter arbeiten können, bei Fragen ruft mich (Julian Baureis) gerne an!
...
***********************************************************************************************************
PCA by Benjamin Nicklas influenced by ChatGPT
***********************************************************************************************************
...
***********************************************************************************************************
kmeans Clustering by Benjamin Nicklas influenced by ChatGPT
***********************************************************************************************************
