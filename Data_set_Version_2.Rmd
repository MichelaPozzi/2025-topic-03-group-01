...
***********************************************************************************************************
7. Identifizierung von Proteinen mit einer unterschiedlichen Anzahl an Maxima in CTRL vs. RNASE
***********************************************************************************************************
...
#Multiple linear regression analysis
model_rnase_pc1_pc2 <- lm(target ~ PC1 + PC2, data = df_regression_ctrl_1)
model_rnase_pc1_pc3 <- lm(target ~ PC1 + PC3, data = df_regression_ctrl_2)
model_rnase_pc2_pc3 <- lm(target ~ PC2 + PC3, data = df_regression_ctrl_3)
