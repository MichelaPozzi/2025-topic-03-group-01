...
```{r}
testing_correlations = correlations(ctrl_main_shift, rnase_main_shift)
testing_correlations$mean_abs_correlation
```

```{r}
compare_correlations = correlations(ctrl_no_main_shift, rnase_no_main_shift)
compare_correlations$mean_abs_correlation
```

Hypothese hat sich bestätigt, yay!
