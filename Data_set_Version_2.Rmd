...
# ctrl/rnase_main_shift contain 1351 proteins 
```
...
hist(
  ...
  main = "Correlation values shifter",
...
hist(
  ...
  main = "Correlation values no_shifter",
  xlab = "Correlation value",
  ylab = "Frequency",
  col = "salmon",
  border = "white",
...
par(mfrow = c(1, 1))
```
It is shown, that by just selecting proteins that exhibit a shift in their main/global maximum, the correlation values are distributed more in the direction of 0, which implies less similar curves between ctrl and rnase for the respective proteins.
...
# In case you want to know the actual protein names of those with very low correlation
# rownames(ctrl_main_shift[near_zero_cors[1], ])
                         
# Plotting a respective curve
cs <- as.numeric(ctrl_main_shift[near_zero_cors[1], 1:25])
rs <- as.numeric(rnase_main_shift[near_zero_cors[1], 1:25])

# Plot
plot(cs,
     type = "l",        
     main = "Plot for the protein",
     xlab = "Fractions",
     ylab = "Values",
     col = "blue",
     lwd = 2)
