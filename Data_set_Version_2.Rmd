...
diff_index = ctrl_3_selection$nb_max != rnase_3_selection$nb_max
#diff_index_only_maxima = ctrl_3_selection$only_max != rnase_3_selection$only_max
same_index = ctrl_3_selection$nb_max == rnase_3_selection$nb_max
...
ctrl_max_list <- lapply(ctrl_3_same_maxima_amount$ctrl_max, as.numeric)
rnase_max_list <- lapply(rnase_3_same_maxima_amount$rnase_max, as.numeric)
