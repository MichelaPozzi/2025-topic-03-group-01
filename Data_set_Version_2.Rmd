...
***********************************************************************************************************
Identifizuerung von Proteinen mit einer unterschiedlichen Anzahl an Maxima in CTRL vs. RNASE
***********************************************************************************************************
...
```{r}
#Erstellen einer Vergleichstabelle, also eines Datenrahmens zum Vergleich der Peakanzahl
peak_difference <- data.frame(protein = rownames(table_ctrl_mean),
  nb_max_ctrl = table_ctrl_mean$nb_max_th,
  nb_max_rnase = table_rnase_mean$nb_max_th
)

#Berechnen der Differenz der Peakmaxima von CTRL gegenüber RNASE
#Zügt die Differenzen als neue Spalte $difference hinzu.

peak_difference$difference <- peak_difference$nb_max_ctrl != peak_difference$nb_max_rnase  
...
***********************************************************************************************************
Identifizuerung von Proteinen bei denen die Maxima um 2 Fraktionen verschoben sind zwischen CTRL und RNASE
***********************************************************************************************************
...
***********************************************************************************************************
Mögliche Anwendung für einen T-Test: Wie ungleich sind die Proteinintensitäten über alle Fraktionen?
***********************************************************************************************************
wie Bens Code
```{r}
...
```{r}
row_data3 <- as.numeric(table.ctrl.fit["PRKDC_HUMAN", 1:25 ])
row_data4 <- as.numeric(table.rnase.fit["PRKDC_HUMAN",1:25 ])
