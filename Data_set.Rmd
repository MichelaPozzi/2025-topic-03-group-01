...
get_differences <- function(ctrl_df, rnase_df, ctrl_col, rnase_col) {
  ctrl_means <- ctrl_df[[ctrl_col]]
  rnase_means <- rnase_df[[rnase_col]]
  return(ctrl_means - rnase_means)
}

# Calculate the difference vectors for both groups
diff_selected <- get_differences(ctrl_selected, rnase_selected, "COM", "COM")
diff_not_selected <- get_differences(ctrl_not_selected, rnase_not_selected, "COM", "COM")
