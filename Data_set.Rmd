...
```{r}
# Expectation: Functions to optimize for Gaussian fitting - Gaussians with 1 to 6 peaks
...
# Expectation: Get the amplitude of the fit at each peak - new column: fit_c
