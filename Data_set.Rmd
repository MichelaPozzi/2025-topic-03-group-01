...
hist(
  ...
  main = "Correlation values for main shifter",
  xlab = "Correlation value",
  ylab = "Frequency",
  col = "skyblue",
  border = "white",
...
hist(
  ...
  main = "Correlation values for not main shifter",
  xlab = "Correlation value",
  ylab = "Frequency",
  col = "salmon",
  border = "white",
...
par(mfrow = c(1, 1))
```
Validation, that "two-sided" shifting proteins may not have a change in their COM value, but could be identified by using a shift of just their global maximum as a criterion. They seem RNA-dependent, even though their correlation value is very high (due to their unchanged COM)
```{r}
# Vector with indices of proteins, that show a near zero correlation between ctrl and rnase
near_one_cors = which(abs(COM_no_shifter$correlations) > 0.9) 
