...
Third t-test is performed (right-sided, one-tailed)
...
par(mfrow = c(1, 1))
```
The different distribution of the isoelectric points between the selected and not selected proteins are clearly visible in the histogram.
