...
It should be further noted, that among our selected proteins are also ones with no big COM shift. They are marked in red. They mostly show their COM value in higher fractions. Per definition, these proteins have a shift in their main maximum between ctrl and rnase, and also have a correlation value < 0.7. These points contain for example proteins, that partially precipitate in the rnase group, and at the same time also partially shift to the left when compared to their ctrl distribution. This may explain the higher presence of these proteins for higher COM values. 
