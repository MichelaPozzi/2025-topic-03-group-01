...
```{r}
#Visualizing data, NOT RIGHT, FIX
NS_Table$Fraction1_Ctrl_Rep1 <- as.numeric(gsub("\\.","", NS_Table$Fraction10_Ctrl_Rep1)) #Ersetzt Punkte, Code auch nicht vollständig verstanden
hist(NS_Table$Fraction1_Ctrl_Rep1, xlab ="Werte?")
```
