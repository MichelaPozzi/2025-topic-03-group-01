...
# Definiere eine neue Tabelle mit 3 Replikaten (entweder CTRL oder RNASE) pro Fraktion.

# data3 ist eine Hilfstabelle um leichter für die table.frxn_.CTROL oder .RNASE Tabellen die richtigen Spalten (aus den Fraktionstabellen table.frxn_) auswählen zu können
...
# Berechnet den Mittelwert jeder Spalte in table.frxn_.CTRL 
# berechnet also den durchschnittlichen Proteinwert über alle Proteine hinweg für jede der 3 Kontrollreplikate
